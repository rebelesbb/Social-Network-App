...
import com.socialnetwork.socialnetworkapp.controller.UserProfileController;
...
import com.socialnetwork.socialnetworkapp.repository.database.*;
...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws IOException {
        ...
        friendshipRepository = new FriendshipPagingRepository(url, username, password, new FriendshipValidator());
